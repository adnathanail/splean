...
def algSpider : ZX 1 1 := .spider .Z 1 1 (1 / 2 : ℚ)
#zx algSpider

def algFusionLHS : ZX 1 1 := .spider .Z 1 1 (1 / 4 : ℚ) ≫ .spider .Z 1 1 (1 / 4 : ℚ)
#zx algFusionLHS
...
def algExercise3point7a : ZX 2 3 :=
  ...
  (.wire ⊗ algNotc)
def algExercise3point7b : ZX 3 3 := .wire ⊗ .hadamard ⊗ .spider .X 1 1 (1 : ℚ)
